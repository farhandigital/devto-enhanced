...
3. **Add viewport visibility check** ✅ **Selected** - Combined approach 2 with additional check to skip auto-scroll if the first heading is visible in viewport.
...
Special thanks to the development team for the thorough performance investigation and architectural improvements that make this extension faster and more maintainable.
...
- **Manual Installation**: Download from [GitHub Releases](https://github.com/farhandigital/devto-enhanced/releases/tag/v0.3.0)

---

## 🔗 Links

- [GitHub Repository](https://github.com/farhandigital/devto-enhanced)
- [Issue Tracker](https://github.com/farhandigital/devto-enhanced/issues)
